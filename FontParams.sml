...
sig
  ...
  val num2:   size -> dist    (* ... in non-display, non-atop *)
  val num3:   size -> dist    (* ... in non-display atop *)
  val denom1: size -> dist    (* denominator shift-down in display style *)
  val denom2: size -> dist    (* ... in non-display styles *)
                              (* superscript shift-up ... *)
  val sup1:   size -> dist    (* ... in uncramped display style *)
  val sup2:   size -> dist    (* ... in uncramped non-display styles *)
  val sup3:   size -> dist    (* ... in cramped styles *)
                              (* subscript shift-down ... *)
  val sub1:   size -> dist    (* ... if superscript is absent *)
  val sub2:   size -> dist    (* ... if superscript is present *)
  val sup_drop: size -> dist  (* superscript baseline below top of large box *)
  val sub_drop: size -> dist  (* subscript baseline below bottom of large box *)
  val delim1: size -> dist    (* size of delimiters in display styles *)
  val delim2: size -> dist    (* size of delimiters in non-displays *)
  val axis_height: size -> dist
                        (* height of fraction lines above the baseline *)
  val default_rule_thickness: size -> dist
                        (* thickness of fraction strokes *)
  val big_op_spacing1: size -> dist  (* minimum clearance above *)
  val big_op_spacing2: size -> dist  (* minimum clearance below *)
  val big_op_spacing3: size -> dist  (* minimum baselineskip above *)
  val big_op_spacing4: size -> dist  (* minimum baselineskip below *)
  val big_op_spacing5: size -> dist  (* padding above and below *)
